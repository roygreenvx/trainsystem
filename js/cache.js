...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['关闭'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">请使用高版本IE或Chrome等高速浏览器浏览此网站</p></pclass></p><p>系统公告暂时保留于此处，以备后续使用</p></div>',
